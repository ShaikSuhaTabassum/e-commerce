...
// //       if (responseData.success) {
// //         // Don't redirect, just switch to Login form
// //         setState("Login");
...
// //             <span onClick={() => { setState("Login"); setErrorMsg(""); }}>Login here</span>
// //           </p>
// //         ) : (
// //           <p className='loginsignup-login'>
// //             Create an account?{" "}
// //             <span onClick={() => { setState("Sign Up"); setErrorMsg(""); }}>Click here</span>
// //           </p>
// //         )}
